...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m🔜🔜OWNER: HANNAN ANSARI')
    jalan("\033[1;96m🔜🔜🔜AGE: 13=SACHI")
    jalan('\033[1;96m🔜🔜🔜🔜R3P0RT3R')
    jalan('\033[1;96m🔜🔜🔜🔜🔜C10N3R')
    jalan("\033[1;96m🔜🔜🔜🔜🔜🔜H4CK3R")
    jalan("\033[1;96m🔜🔜🔜🔜🔜🔜🔜DEVICE:SAM.J3😢😭")
    jalan('\033[1;96m🔜🔜🔜🔜🔜🔜🔜🔜Slow CLONING HE YR wait kr😁😁')
