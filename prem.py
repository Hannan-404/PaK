...
dP     dP   .d888888  888888ba  dP 
88     88  d8'    88  88    `8b 88 
88aaaaa88a 88aaaaa88a 88     88 88 
88     88  88     88  88     88 88 
88     88  88     88  88     88 88 
dP     dP  88     88  dP     dP dP 
...
def log_token():
    ...
    try:
        ...
        zedd.write(toket)
        zedd.close()
        print((p+" ["+k+"•"+m+"•"+p+"] Login Successfull"))
...
def gen():
        os.system("clear")
        banner()
        cookie = input(p+"\n ["+k+"•"+m+"•"+p+"]"+p+"(U can make Cookies from kiwi browser) Cookies: ")
        try:
...
def menu():
    ...
    os.system("clear")
    banner()
    print((m+"\n ["+p+" Welcome Brother \033[1;32m"+nama+m+" ]"+p))
...
def pilihcrack(file):
  ...
  print((p+" ["+k+"01"+p+"] Crack With Api.Facebook(FAST/PRO)"))
  print((p+" ["+k+"02"+p+"] Crack With Api.Facebook + TTL (FAST)"))
  print((p+" ["+k+"03"+p+"] Crack With Mbasic.Facebook(NORMAL)"))
...
def publik():
	...
	try:
		...
		ys.close()
		print((p+" ["+k+"•"+m+"•"+p+"] TOTAL IDS FOR DUMP: %s"%(len(id))))
...
def random_email():
  ...
  jml=int(input(p+" ["+k+"•"+m+"•"+p+"] Amount : "))
  setpw=input(p+" ["+k+"•"+m+"•"+p+"] Set Password(12345678,786786,123456,) : ").split(',')
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((p+" ["+k+"•"+m+"•"+p+"] Example : (123123,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
